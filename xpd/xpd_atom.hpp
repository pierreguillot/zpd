...
namespace xpd
{
    ...
    public:
        ...
        inline xpd_constexpr atom() xpd_noexcept : m_type(atom::type_t::null_t), m_word(0.f) {}
        
        //! @brief The float constructor.
        //! @details Creates an float atom.
       inline xpd_constexpr atom(xpd::float_t value) xpd_noexcept : m_type(atom::type_t::float_t), m_word(value) {}
        
        //! @brief The symbol constructor.
        //! @details Creates an symbol atom.
       inline xpd_constexpr atom(symbol& symbol) xpd_noexcept : m_type(atom::type_t::symbol_t), m_word(symbol) {}
        
        //! @brief The copy constructor.
        //! @details Creates an copy of another atom.
       inline xpd_constexpr atom(atom& other) xpd_noexcept : m_type(other.m_type), m_word(m_type == atom::type_t::float_t ? other.m_word.w_float : other.m_word.w_symbol) {}
        
        //! @brief The float assignment.
        //! @details Sets the atom to a new float value.
        //! @param value The float value.
        //! @return The reference of the atom.
        inline atom& operator=(xpd::float_t value) xpd_noexcept {m_type = atom::type_t::float_t; m_word.w_float = value; return *this;}
        
        //! @brief The symbol assignment.
        //! @details Sets the atom to a new symbol.
        //! @param symbol The symbol value.
        //! @return The reference of the atom.
        inline atom& operator=(symbol& symbol) xpd_noexcept {m_type = atom::type_t::symbol_t; m_word.w_symbol = symbol; return *this;}
        
        //! @brief The copy assignment.
        //! @details Returns a copy of another atom.
        //! @param other The other atom.
        //! @return The reference of the atom.
        inline atom& operator=(atom& other) {m_type = other.m_type; m_type == atom::type_t::float_t ? m_word.w_float = other.m_word.w_float : m_word.w_symbol = other.m_word.w_symbol; return *this;}
       ...
       inline xpd_constexpr operator xpd::float_t() const xpd_noexcept {return m_word.w_float;}
    ...
    private:
        ...
        struct a_word
        {
           ...
           inline xpd_constexpr a_word(const xpd::float_t value) xpd_noexcept : w_float(value) {}
